...
bool make_attack_ranged(monster_type *m_ptr, int attack, int py, int px)
{
    ...
    switch (attack)
    {
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_BR_INERTIA);
            if (blind) message(QString("%^1 breathes.") .arg(m_name));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_BR_GRAVITY);
            if (blind) message(QString("%^1 breathes.") .arg(m_name));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_BR_DISENCHANT);
            if (blind) message(QString("%^1 breathes.") .arg(m_name));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_CREATE_TRAP);
        ...
        case 192 + 0:
        {
            disturb(1, 0);
            if (blind) message(QString("%^1 mumbles.") .arg(m_name));
            else message(QString("%^1 magically summons %2 %3.") .arg(m_name)
                .arg(m_poss)  .arg((r_ptr->flags1 & (RF1_UNIQUE)) ? "minions" : "kin"));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_SUM_MONSTER);
            if (blind) message(QString("%^1 mumbles.") .arg(m_name));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_SUM_SPIDER);
            if (blind) message(QString("%^1 mumbles.") .arg(m_name));
        ...
        {
            disturb(1, 0);
            // TODO // TODO sound(MSG_SUM_ANIMAL);
            if (blind) message(QString("%^1 mumbles.") .arg(m_name));
